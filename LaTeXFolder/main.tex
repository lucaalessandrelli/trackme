...
\begin{figure}[H]
\centering
\includegraphics[scale = 0.4]{Images/Logo/logo.jpg}\\
[1cm]
\end{figure}
{\fontsize{40}{40} \selectfont{\textcolor{Blue}{\textsc{\bfseries  TrackMe RASD}}}}\\[0.5cm]
{\fontsize{25}{70} \selectfont{\textcolor{Blue}{\textbf{{Requirement Analysis and Specification
        Document}}}}}\\[0.5cm]     
