...
Security for sensitive information is one of the goals of this system. In order to guarantee users' privacy the system implements certificated security communication protocol.
...
Data4Help service can be reached by third parties from http requests, so every browser can be perform request and retrieve users' data.
