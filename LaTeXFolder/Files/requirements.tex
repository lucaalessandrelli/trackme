...
\medbreak
\noindent
Track4Run users can use an App for smartphone and another one for smartwatch. The first one could be used by everyone, while the second one is made specifically for the athletes. Like for AutomatedS0S, there is not any interface provided for third parties.
\bigbreak
\noindent
...
\begin{center}
	...
	\caption{Privacy Policy pt.1 Mockup}
        \end{minipage}%
        \hspace{10mm}%
        \begin{minipage}[c]{.40\textwidth}
        \centering
          \includegraphics[height=10.4  cm]{Images/Mockups/Track4RunMockup3.jpg}
	\caption{Privacy Policy pt.2 Mockup}
        \end{minipage}
      \end{center}
\end{figure}
\begin{figure}[H]
...
\FloatBarrier
\begin{table}[h]
\begin{tabular}{|p{3.4cm}|p{.75\textwidth}|}
\hline
Name             & Sign Up \\ \hline
