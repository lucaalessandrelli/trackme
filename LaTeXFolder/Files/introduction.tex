...
1.1     & Corrected orthographic errors. & / \\ \hline
 & Added text assumptions, modified use cases, mockups, requirements and class diagram. & In the first version of the document Data4Help would also answer to third party requests with data retrieved by AutomatedSOS, leading to major exploitation of very sensitive data.   \\ \hline
 ...
 & Modified requirements, mockups, product functions, text assumptions and use cases. & In the first version of the document the logic behind promoting and enrolling to a run event wasn't explained enough. \\ \hline
\end{tabular}
\caption{Revision History Version 1.1}
\end{table}
...
& Modified use cases and use case diagrams & In the new version of the document a discrepancy about the subscription to a group got fixed.  \\ \hline
 ...
 & Modified mockups & In this version of the document a new web page for third parties got added inside the "User Interface" section. \\ \hline
  & Modified definitions & \ \\ \hline
  & Modified Alloy & In this version the world generated by Alloy is more complete and correct. \ \\ \hline
\end{tabular}
\caption{Revision History Version 1.2}
\end{table}
