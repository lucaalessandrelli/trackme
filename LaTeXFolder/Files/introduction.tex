...
\item[•] {\Large Data4Help}
	\begin{enumerate}
		\item [G.1] Provide to Third Parties, the users' position and heath status.
		\begin{enumerate}
		...
		\end{enumerate}
		\item [G.2] Allow third parties two different ways to get users' data.
		\begin{enumerate}
		...
		\item [G.5] Allow third parties statistics about users.
	\end{enumerate}
