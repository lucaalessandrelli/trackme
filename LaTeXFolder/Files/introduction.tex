...
Here is described all the world phenomena, so what the machine cannot observe
\begin{enumerate}
\item[•] Users' location and health status when their device is not active or reachable.
\item[•] Internet communication breakdown.
\item[•] Ambulance position on AutomatedSOS application.
\end{enumerate}
